...
class MyDiscusseControllerTest extends BaseCase
{

    public function test_mobile_my_lesson_discusses_list_data()
    {
        ...
        $response = $this->json('GET', 'api/item/discusse/' . $this->lesson->id . '/my_lesson_discusses');
